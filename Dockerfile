...
# --- Run With:
# docker run --name <> -e DJANGO_ALLOW_HOST=<> -e DJANGO_SECRET_KEY=<> -e STRIPE_SECRET_KEY=<> -e STRIPE_PUBLIC_KEY=<> -e PAYPAL_MODE=<sandbox|production> -p <host_port>:80 -v </host/path/to/db/dir/>:/opt/meditate/database/ <image>
